...
class SponsorContacts {
  ...
  static sponsorEgghead() async {
    const url = 'https://egghead.io/';
    if (await canLaunch(url)) {
      await launch(url);
    } else {
      throw 'Could not launch $url';
  ...
  static sponsorLumos() async {
    const url = 'https://www.lumoslabs.co/';
    if (await canLaunch(url)) {
      await launch(url);
    } else {
      throw 'Could not launch $url';
  ...
  static sponsorCodex() async {
    const url = 'https://thecodex.me/';
    if (await canLaunch(url)) {
      await launch(url);
    } else {
      throw 'Could not launch $url';
